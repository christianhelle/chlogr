...
|-----------|----------|----------|
| Core Zig implementation | Mr. Orange | changelog_generator.zig, github_api.zig, http_client.zig, cli.zig, models.zig, token_resolver.zig, main.zig |
| Tests & quality | Mr. Pink | test.zig, test_data.zig, edge cases, quality gates |
| Build system & releases | Mr. Blonde | build.zig, install.ps1, install.sh, snapcraft.yaml, CI/CD workflows |
| Code review | Mr. White | Review PRs, check quality, architectural decisions |
| Testing | Mr. Pink | Write tests, find edge cases, verify fixes |
